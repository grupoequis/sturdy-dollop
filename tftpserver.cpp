        ...
        /*****************************************/
            ...
            while(!set){
                ...
                while(1){
                    ...
                    int packet_len = recvfrom(conn_socket, buff, 1024, 0, (struct sockaddr *) &cl_addr, &cl_len);
                    if(packet_len > 4){
                        send_error(4, conn_socket, (struct sockaddr *) &cl_addr, cl_len);
                        break;
                    }else{
